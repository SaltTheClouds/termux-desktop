...
_pkgs=(bc bmon calc calcurse curl dbus desktop-file-utils elinks feh fontconfig-utils fsmon \
		geany git gtk2 gtk3 htop imagemagick jq l3afpad mandoc mpc mpd mutt ncmpcpp \
...
uninstall_td() {
	...
	_configfiles=(Thunar geany  gtk-3.0 l3afpad netsurf openbox polybar ranger rofi xfce4)
