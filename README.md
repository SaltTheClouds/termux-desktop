...
You must install from f-droid. The version from the play store is deprecated. <br />
...
```
git clone --depth=1 [https://github.com/adi1090x/termux-desktop.git](https://github.com/SaltTheClouds/termux-desktop.git)
```
